...
interface URLButton extends InlineKeyboardButton {
    /**
...
interface CallbackDataButton extends InlineKeyboardButton {
    /**
...
interface SwitchInlineQueryButton extends InlineKeyboardButton {
    /**
     ...
     * are currently in a private chat with it. Especially useful when combined with switch_pm… actions – in this case the
     * user will be automatically returned to the chat they switched from, skipping the chat selection screen.
     */
    switch_inline_query?: string;
}

interface SwitchInlineQueryCurrentChatButton extends InlineKeyboardButton {
    /**
     * Optional. If set, pressing the button will insert the bot‘s username and the specified inline query in the current
     * chat's input field. Can be empty, in which case only the bot’s username will be inserted. This offers a quick
...
interface CallbackGameButton extends InlineKeyboardButton {
    /**
...
interface PayButton extends InlineKeyboardButton {
    /**
...
export default TelegramInlineKeyboardButton;
